...
<div className="mx-auto max-w-6xl h-12 px-4 sm:px-6 lg:px-6 flex items-center justify-between">
<a href="#" className="font-extrabold tracking-tight text-emerald-600 text-lg">Jorge García Rodríguez</a>
